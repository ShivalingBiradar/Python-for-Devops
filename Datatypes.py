...
first_list = [str1, str2, str3, str4, "Devops", 47, num1, 1.5 ]
...
first_tuple = ( str1, str2, str3, str4, "Devops", 47, num1, 1.5 )

# Printing a tuple

print(first_tuple)

# Dictionary / Elements in the dictionry are always in pairs(Key:Value), curly brackets.

first_dictionary = {"Name": "Shivaling", "Weight":75, "Exersises":["Boxing", "Dancing","Jogging"]}
